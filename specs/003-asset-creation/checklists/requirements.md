...
- 2026-08-23 澄清会话（5 问）：协作式草稿（FR-004）；Health Check 强制必选、消除开关（FR-007，待回写 PRD）；能力声明只读镜像（FR-010/014）；MCP 托管方式 P0 单值「远程服务（业务方自托管）」（FR-013）；动态凭据真实鉴权探测（FR-008，关闭一条 Open Question）。
