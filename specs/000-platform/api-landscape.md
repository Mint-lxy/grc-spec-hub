...
| GET | /mgmt/knowledge/knowledge-bases/{kbId}/documents/{docId}/enhance | 查询文档增强产物 | Path: KnowledgeBaseId; Path: DocumentId; ?jobId; ?page; ?pageSize | KnowledgeDocumentEnhancePageEnvelope | 005 |
| GET | /mgmt/knowledge/knowledge-bases/{kbId}/documents/{docId}/chunks | 查询文档切片列表 | Path: KnowledgeBaseId; Path: DocumentId; ?jobId; ?keyword; ?page; ?pageSize; ?snippetContext | KnowledgeDocumentChunkPageEnvelope | 005 |
...
| GET | `/mgmt/knowledge/knowledge-bases/{kbId}/documents/{docId}/chunks` | 查询切片列表 | Path: `kbId`, `docId`; `?jobId?, keyword?, page?, pageSize?, snippetContext?` | `{ knowledgeBaseId, documentId, jobId, stats, items[]{ chunkId, seq, content, tokenCount, charCount, embedStatus, parentId, positionMeta, sourceSnippet, snippetStart, snippetEnd, metadata, createdAt, updatedAt }, page, pageSize, total }` | 005 |
...
| GET | `/mgmt/knowledge/knowledge-bases/{kbId}/documents/{docId}/enhance` | 查询文档增强产物 | Path: `kbId`, `docId`; `?jobId?, page?, pageSize?` | `{ knowledgeBaseId, documentId, jobId, itemsByType, stats }` | 005 |
