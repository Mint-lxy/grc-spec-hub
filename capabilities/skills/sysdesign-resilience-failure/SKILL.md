---
name: sysdesign-resilience-failure
...
3. **Set the key knobs** �?timeout = the dependency's measured p99; retry cap
   (often 2�?) plus a per-request budget and jitter; breaker open/half-open
...
(often 2�?) and apply a budget so total attempts can't explode. Each extra
