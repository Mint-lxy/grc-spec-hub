---
name: sysdesign-back-of-the-envelope
...
| Cache server (Redis/Memcached) | ~**100,000�?M** QPS |
...
- **Do size on peak, not average.** State the peak multiplier (�?× is a common
...
- **`references/estimation-recipes.md`** �?worked examples (Twitter-scale QPS + storage, the 64-core�?4k req/s CPU-time derivation, bandwidth and server-count sizing). Read to see a full chain end to end.
