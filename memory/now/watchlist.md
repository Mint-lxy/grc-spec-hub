...
| 17 | §9.10 参数基线逐项审定（共 27 行：原 23 行 + 2026-08-21 新增 4 行——我的目录单库分享人数上限、知识库名称长度与字符集、资产收藏数量上限、平台级并发构建流水线数上限）——以 interview 一问一答逐项审核，BA 跟进 | 基线 | spec 000, PRD §13.10 #11 | in-progress |
